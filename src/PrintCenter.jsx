...
export function CommunityPartnerFlyerFront({ standalone = true } = {}) {
  const restorationItems = [
    { icon: Mountain, title: 'Return to Hiking' },
    { icon: Briefcase, title: 'Return to Work' },
    { icon: Heart, title: 'Regain Confidence' },
    { icon: Dumbbell, title: 'Restore Strength' },
    { icon: Users, title: 'Be Present with Family' },
    { icon: TrendingUp, title: 'Improve Quality of Life' },
  ]
...
export function CommunityPartnerFlyerBack({ standalone = true } = {}) {
  const timelineSteps = [
    {
      title: 'Conversation',
...
export function CommunityPartnerLeaveBehind() {
  return (
    <div className="bg-[#f8f5ef]">
      ...
      <CommunityPartnerFlyerFront standalone={false} />
      <CommunityPartnerFlyerBack standalone={false} />
    </div>
  )
}
