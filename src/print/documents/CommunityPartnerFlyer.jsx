...
<div
  className="absolute top-0 left-[3.75in] h-full w-[1.5in] print:left-[3.75in] print:w-[1.35in]"
  style={{
    background:
      'linear-gradient(to right,#fbfaf7 0%,rgba(251,250,247,.94) 22%,rgba(251,250,247,.58) 55%,transparent 100%)',
  }}
/>
